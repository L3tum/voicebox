...
def build_server(cuda=False):
    ...
    args.extend(
        [
            ...
            # dots.tts — 2B continuous AR TTS, 48kHz output, 24 languages
            "--hidden-import",
            "backend.backends.dots_tts_backend",
            "--hidden-import",
            "dots_tts",
            "--hidden-import",
            "dots_tts.runtime",
            "--hidden-import",
            "dots_tts.models.dots_tts.model",
            "--hidden-import",
            "dots_tts.modules.speaker.encoder",
            "--hidden-import",
            "dots_tts.modules.vocoder.bigvgan",
            "--hidden-import",
            "dots_tts.utils.text",
            "--hidden-import",
            "dots_tts.utils.audio",
            "--hidden-import",
            "dots_tts.data.pipelines.tts_pipeline",
            "--hidden-import",
            "dots_tts.data.pipelines.tokenizing",
            "--collect-all",
            "dots_tts",
            # torchdiffeq — ODE solver used by dots.tts flow matching
            "--hidden-import",
            "torchdiffeq",
            "--collect-submodules",
            "torchdiffeq",
            # lingua-language-detector — ships language model data files
            "--collect-all",
            "lingua",
            # langcodes — language code normalization
            "--hidden-import",
            "langcodes",
            "--collect-all",
            "langcodes_data",
            # WeTextProcessing — text normalization (Chinese + English)
            "--collect-all",
            "WeTextProcessing",
            "--collect-all",
            "misaki",
