...
FROM python:3.11-slim@sha256:4e3c004985e24cb8009a5f3aa42de4d36549326caadb2412c808dc7c5ab62d68 AS backend-builder
...
RUN pip install --no-cache-dir --prefix=/install --no-deps dots.tts
RUN pip install --no-cache-dir --prefix=/install \
    git+https://github.com/QwenLM/Qwen3-TTS.git


# === Stage 3: Runtime ===
FROM python:3.11-slim@sha256:4e3c004985e24cb8009a5f3aa42de4d36549326caadb2412c808dc7c5ab62d68
